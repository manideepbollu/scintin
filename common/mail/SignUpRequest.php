...
$identifyLink = urldecode(Yii::$app->urlManager->createAbsoluteUrl(['site/signup', 'type' => $requestData->userType, 'token' => $offUser->signup_request_token]));
?>
...
<?= Html::a($identifyLink, $identifyLink) ?>
